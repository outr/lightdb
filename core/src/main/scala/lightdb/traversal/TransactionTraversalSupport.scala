...
trait TransactionTraversalSupport[Doc <: Document[Doc], Model <: DocumentModel[Doc]] {
  ...
  object traversal {
     ...
     */
    def forward[E <: EdgeDocument[E, From, To], From <: Document[From], To <: Document[To]](model: EdgeModel[E, From, To])
     ...
     */
    def reverse[E <: EdgeDocument[E, From, To], From <: Document[From], To <: Document[To]](model: EdgeModel[E, From, To])
    ...
    // In TransactionTraversalSupport.traversal object
