...
| [ArangoDB](https://www.arangodb.com)                                  | Multi-Model (Doc/Graph) | ❌ (Server-based) | ✅ | ✅✅✅   | ✅✅      | ✅✅         | 🟡 (Transactional batching; not ACID) | 🟡 (REGEX_TEST)  | ❌        | AQL queries, native nested, aggregation, facets |
