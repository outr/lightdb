...
object TightLoops {
  ...
  private val SearchIterations = 100
  ...
  def streamRecords()(implicit transaction: Transaction[Person]): Unit = (0 until StreamIterations)
    .iterator
    .foreach { _ =>
  ...
  def searchRecords()(implicit transaction: Transaction[Person]): Unit = (0 until SearchIterations)
    .iterator
    .foreach { _ =>
      (0 until RecordCount)
        .iterator
