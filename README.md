...
To add all modules:
```scala
libraryDependencies += "com.outr" %% "lightdb-all" % "4.29.0"
```

For a specific implementation like Lucene:
```scala
libraryDependencies += "com.outr" %% "lightdb-lucene" % "4.29.0"
```

For graph traversal utilities:
```scala
libraryDependencies += "com.outr" %% "lightdb-traversal" % "4.29.0"
```

For OpenSearch:
```scala
libraryDependencies += "com.outr" %% "lightdb-opensearch" % "4.29.0"
```
...
//   input = FlatMap(
//     input = Suspend(
//       f = lightdb.store.Store$TransactionBuilder$$Lambda/0x000000000da01f48@6dd844d3,
...
//       )
//     ),
//     f = lightdb.store.Store$TransactionBuilder$$Lambda/0x000000000da03960@5c9b9655,
//     trace = SourcecodeTrace(
//       file = File(
//         "/home/mhicks/projects/open/lightdb/core/src/main/scala/lightdb/store/Store.scala"
//       ),
...
//     )
//   ),
//   f = lightdb.store.Store$TransactionBuilder$$Lambda/0x000000000da04508@163d7c1f,
//   trace = SourcecodeTrace(
//     file = File(
//       "/home/mhicks/projects/open/lightdb/core/src/main/scala/lightdb/store/Store.scala"
//     ),
...
//   nicknames = Set(),
//   friends = List(),
//   _id = StringId("Gi64UOAbbbHLiicqtoIYsZXxsPAKoGSk")
// )
...
// Results: List(MaterializedAggregate({"ageMin": 21, "ageMax": 21, "ageAvg": 21.0, "ageSum": 882},repl.MdocSession$MdocApp$Person$@35764e4b))
```
...
//   _id = StringId("NSDw5UQcm2nFiYWSB0EJeiItF3C64iJb")
// )
...
//   _id = StringId("KPD3Z6HdwFnkhKgAYsGcDZ6EfQPYcNs9")
// )
...
// tenantA: HashMapStore[TenantDoc, TenantDoc] = lightdb.store.hashmap.HashMapStore@201aed93
tenantA.transaction(_.insert(TenantDoc("hello"))).sync()
// res14: TenantDoc = TenantDoc(
//   value = "hello",
//   _id = StringId("m6H0ARZb6MPwAQZ0eU2A6tPy79HylVee")
// )
```
...
//   key = "featureX",
//   store = lightdb.store.hashmap.HashMapStore@7f92612d,
//   default = repl.MdocSession$MdocApp$$Lambda/0x000000000dc29ca0@44e2db0e,
//   persistence = Stored
// )
...
// res18: Row = Row(
//   value = "hi sql",
//   _id = StringId("Cp25rx8cnAcNl49nvAR1WYhuTDLcPF8d")
// )
```
