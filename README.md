...
To add all modules:
```scala
libraryDependencies += "com.outr" %% "lightdb-all" % "4.6.0"
```

For a specific implementation like Lucene:
```scala
libraryDependencies += "com.outr" %% "lightdb-lucene" % "4.6.0"
```
...
//   nicknames = Set(),
//   friends = List(),
//   _id = StringId(value = "JsIjdvS1yYmQ5wvVy0zUisC9y22GcM06")
// )
...
// People in their 20s: List(Person(Adam,21,None,Set(),List(),StringId(48BFaAenOJFvTNgTBj4Hz6rOd9zVOpMl)), Person(Adam,21,None,Set(),List(),StringId(i4QdxqDz06itoSnWveEpjXIBwa3rgrMV)), Person(Adam,21,None,Set(),List(),StringId(wtfyS1xDvc4CoFs7i78QqgrY0wbiiHdf)), Person(Adam,21,None,Set(),List(),StringId(uGBLDGMp8NIrCBKY1DFEkbzPUcnx5F2w)), Person(Adam,21,None,Set(),List(),StringId(PnXSHAeVnWvKf7OSVjVlniLtbHhYyIo1)), Person(Adam,21,None,Set(),List(),StringId(mxVbgbQULq2paJYupNWyoBaG9B8ImWia)), Person(Adam,21,None,Set(),List(),StringId(ev0pd6XUQKisWEu5E6HIjmnYrGEswH4q)), Person(Adam,21,None,Set(),List(),StringId(3JBivO0KgHxTcFBrqhLi2tMJM437ubrd)), Person(Adam,21,None,Set(),List(),StringId(zT1BCAFYPcsdCTeX09GWXXmFen5Bmfb2)), Person(Adam,21,None,Set(),List(),StringId(nOlGIZKkgWYO2KQ3lxFl65ja904mPLmT)), Person(Adam,21,None,Set(),List(),StringId(9PPjdlLaCfZM4mLYFGK0qV6f0LQFvHeI)), Person(Adam,21,None,Set(),List(),StringId(JsIjdvS1yYmQ5wvVy0zUisC9y22GcM06)))
```
...
// Results: List(MaterializedAggregate({"ageMin": 21, "ageMax": 21, "ageAvg": 21.0, "ageSum": 252},repl.MdocSession$MdocApp$Person$@185f5c5))
```
