...
To add all modules:
```scala
libraryDependencies += "com.outr" %% "lightdb-all" % "4.3.1"
```

For a specific implementation like Lucene:
```scala
libraryDependencies += "com.outr" %% "lightdb-lucene" % "4.3.1"
```
...
//   nicknames = Set(),
//   friends = List(),
//   _id = StringId(value = "PnXSHAeVnWvKf7OSVjVlniLtbHhYyIo1")
// )
...
// Results: List(MaterializedAggregate({"ageMin": 21, "ageMax": 21, "ageAvg": 21.0, "ageSum": 105},repl.MdocSession$MdocApp$Person$@7b25597c))
```
