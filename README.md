...
To add all modules:
```scala
libraryDependencies += "com.outr" %% "lightdb-all" % "4.44.0"
```

For a specific implementation like Lucene:
```scala
libraryDependencies += "com.outr" %% "lightdb-lucene" % "4.44.0"
```
...
```scala
libraryDependencies += "com.outr" %% "lightdb-tantivy" % "4.44.0"
```

For graph traversal utilities:
```scala
libraryDependencies += "com.outr" %% "lightdb-traversal" % "4.44.0"
```

For OpenSearch:
```scala
libraryDependencies += "com.outr" %% "lightdb-opensearch" % "4.44.0"
```
...
//   input = FlatMap(
//     input = Suspend(
//       f = lightdb.store.Store$TransactionBuilder$$Lambda/0x00000000389ae270@6a1efb6b,
...
//       )
//     ),
//     f = lightdb.store.Store$TransactionBuilder$$Lambda/0x00000000389b0000@6d253fdf,
//     trace = SourcecodeTrace(
//       file = File(
//         "/home/mhicks/projects/open/lightdb/core/src/main/scala/lightdb/store/Store.scala"
//       ),
...
//     )
//   ),
//   f = lightdb.store.Store$TransactionBuilder$$Lambda/0x00000000389b0ba0@624608ab,
//   trace = SourcecodeTrace(
//     file = File(
//       "/home/mhicks/projects/open/lightdb/core/src/main/scala/lightdb/store/Store.scala"
//     ),
...
//   nicknames = Set(),
//   friends = List(),
//   _id = StringId("ZbH5BrLHnMnP4Xufp05athlyGnNI7Ets")
// )
...
// Results: List(MaterializedAggregate({"ageMin": 21, "ageMax": 21, "ageAvg": 21.0, "ageSum": 1344},repl.MdocSession$MdocApp$Person$@628ad65a,Map()))
```
...
//   _id = StringId("pSrj2HHn8uTn6IpbXecPJS3JHYVJ5Kss")
// )
...
//   _id = StringId("2OPPRomc33IuNuIRb75eZmclhMzekyK2")
// )
...
// tenantA: HashMapStore[TenantDoc, TenantDoc] = lightdb.store.hashmap.HashMapStore@777c9279
tenantA.transaction(_.insert(TenantDoc("hello"))).sync()
// res14: TenantDoc = TenantDoc(
//   value = "hello",
//   _id = StringId("TQGGWfHstALYc7cf2MPA2RGFszE4zVUJ")
// )
```
...
//   key = "featureX",
//   store = lightdb.store.hashmap.HashMapStore@4e42e3dc,
//   default = repl.MdocSession$MdocApp$$Lambda/0x0000000038c34c50@218c0ab0,
//   persistence = Stored
// )
...
// res18: Row = Row(
//   value = "hi sql",
//   _id = StringId("t88VVnUkNt16D4XLR8fZ2pnirqe8q5Wv")
// )
```
