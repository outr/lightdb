...
To add all modules:
```scala
libraryDependencies += "com.outr" %% "lightdb-all" % "4.5.0"
```

For a specific implementation like Lucene:
```scala
libraryDependencies += "com.outr" %% "lightdb-lucene" % "4.5.0"
```
...
//   nicknames = Set(),
//   friends = List(),
//   _id = StringId(value = "zT1BCAFYPcsdCTeX09GWXXmFen5Bmfb2")
// )
...
// Results: List(MaterializedAggregate({"ageMin": 21, "ageMax": 21, "ageAvg": 21.0, "ageSum": 189},repl.MdocSession$MdocApp$Person$@25e5d90e))
```
