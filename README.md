...
To add all modules:
```scala
libraryDependencies += "com.outr" %% "lightdb-all" % "4.3.2"
```

For a specific implementation like Lucene:
```scala
libraryDependencies += "com.outr" %% "lightdb-lucene" % "4.3.2"
```
...
//   nicknames = Set(),
//   friends = List(),
//   _id = StringId(value = "mxVbgbQULq2paJYupNWyoBaG9B8ImWia")
// )
...
// Results: List(MaterializedAggregate({"ageMin": 21, "ageMax": 21, "ageAvg": 21.0, "ageSum": 126},repl.MdocSession$MdocApp$Person$@7f3f236f))
```
