...
To add all modules:
```scala
libraryDependencies += "com.outr" %% "lightdb-all" % "4.47.0"
```

For a specific implementation like Lucene:
```scala
libraryDependencies += "com.outr" %% "lightdb-lucene" % "4.47.0"
```
...
```scala
libraryDependencies += "com.outr" %% "lightdb-tantivy" % "4.47.0"
```

For graph traversal utilities:
```scala
libraryDependencies += "com.outr" %% "lightdb-traversal" % "4.47.0"
```

For OpenSearch:
```scala
libraryDependencies += "com.outr" %% "lightdb-opensearch" % "4.47.0"
```
...
//   input = FlatMap(
//     input = Suspend(
//       f = lightdb.store.Store$TransactionBuilder$$Lambda/0x00000000519e56c8@6b768e8,
...
//       )
//     ),
//     f = lightdb.store.Store$TransactionBuilder$$Lambda/0x00000000519e70a8@f0c8a2f,
//     trace = SourcecodeTrace(
//       file = File(
//         "/home/mhicks/projects/open/lightdb/core/src/main/scala/lightdb/store/Store.scala"
//       ),
...
//     )
//   ),
//   f = lightdb.store.Store$TransactionBuilder$$Lambda/0x00000000519e8000@47260b9b,
//   trace = SourcecodeTrace(
//     file = File(
//       "/home/mhicks/projects/open/lightdb/core/src/main/scala/lightdb/store/Store.scala"
//     ),
...
//   nicknames = Set(),
//   friends = List(),
//   _id = StringId("Hs5kCe3cqMECvFiYC6HneLekTISR97yr")
// )
...
// Results: List(MaterializedAggregate({"ageMin": 21, "ageMax": 21, "ageAvg": 21.0, "ageSum": 1407},repl.MdocSession$MdocApp$Person$@213aaa6f,Map()))
```
...
//   _id = StringId("o7DP7GmrbGHQJflu7xJhc4T8k2rZ2Nq2")
// )
...
//   _id = StringId("HWs1dcF9HlPKCBjx5Kn8rCzJ6vubYUYu")
// )
...
// tenantA: HashMapStore[TenantDoc, TenantDoc] = lightdb.store.hashmap.HashMapStore@1ffee2f2
tenantA.transaction(_.insert(TenantDoc("hello"))).sync()
// res14: TenantDoc = TenantDoc(
//   value = "hello",
//   _id = StringId("xnhD6M8xq1PUMgEu51MxDAYM1FxmIR6t")
// )
```
...
//   key = "featureX",
//   store = lightdb.store.hashmap.HashMapStore@5b5bbf37,
//   default = repl.MdocSession$MdocApp$$Lambda/0x0000000051c18c50@2fe38492,
//   persistence = Stored
// )
...
// res18: Row = Row(
//   value = "hi sql",
//   _id = StringId("VtkVadkn0cDggGVl96CLVG2JXxqlIB7U")
// )
```
