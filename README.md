...
To add all modules:
```scala
libraryDependencies += "com.outr" %% "lightdb-all" % "4.26.3"
```

For a specific implementation like Lucene:
```scala
libraryDependencies += "com.outr" %% "lightdb-lucene" % "4.26.3"
```

For graph traversal utilities:
```scala
libraryDependencies += "com.outr" %% "lightdb-traversal" % "4.26.3"
```

For OpenSearch:
```scala
libraryDependencies += "com.outr" %% "lightdb-opensearch" % "4.26.3"
```
...
//   input = FlatMap(
//     input = Suspend(
//       f = lightdb.store.Store$TransactionBuilder$$Lambda/0x000000000d9db408@58d2e985,
...
//       )
//     ),
//     f = lightdb.store.Store$TransactionBuilder$$Lambda/0x000000000d9dce20@5d4dfc55,
//     trace = SourcecodeTrace(
//       file = File(
//         "/home/mhicks/projects/open/lightdb/core/src/main/scala/lightdb/store/Store.scala"
//       ),
...
//     )
//   ),
//   f = lightdb.store.Store$TransactionBuilder$$Lambda/0x000000000d9dd9c8@50a7e199,
//   trace = SourcecodeTrace(
//     file = File(
//       "/home/mhicks/projects/open/lightdb/core/src/main/scala/lightdb/store/Store.scala"
//     ),
...
//   nicknames = Set(),
//   friends = List(),
//   _id = StringId("kSxSXVhD1jPH1cxQftUpJ1REMFe7EzEP")
// )
...
// Results: List(MaterializedAggregate({"ageMin": 21, "ageMax": 21, "ageAvg": 21.0, "ageSum": 777},repl.MdocSession$MdocApp$Person$@68fc9b0c))
```
...
//   _id = StringId("fh190Glr84aGcZljTcDdOK4VPRH7bgRb")
// )
...
//   Note(
//     text = "the quick brown fox",
//     _id = StringId("UUUfD5ZVw3VTIRSjBBfDM8tNS6dRBXC1")
//   ),
// ...
```
...
//   _id = StringId("r9nz6GcXrwctVXTvJFMMvcmOGfzkkf1M")
// )
...
// tenantA: HashMapStore[TenantDoc, TenantDoc] = lightdb.store.hashmap.HashMapStore@2aac9f96
tenantA.transaction(_.insert(TenantDoc("hello"))).sync()
// res14: TenantDoc = TenantDoc(
//   value = "hello",
//   _id = StringId("DXkX91iLhQlv6TqDH5hZHIUHIkcPWMrR")
// )
```
...
//   key = "featureX",
//   store = lightdb.store.hashmap.HashMapStore@2a669923,
//   default = repl.MdocSession$MdocApp$$Lambda/0x000000000dbc1ca0@5d09fe76,
//   persistence = Stored
// )
...
// res18: Row = Row(
//   value = "hi sql",
//   _id = StringId("ZIKl9tm66Lvf0ouiq1cWASR0FG4G6Scc")
// )
```
