...
To add all modules:
```scala
libraryDependencies += "com.outr" %% "lightdb-all" % "4.1.0"
```

For a specific implementation like Lucene:
```scala
libraryDependencies += "com.outr" %% "lightdb-lucene" % "4.1.0"
```
...
//   nicknames = Set(),
//   friends = List(),
//   _id = StringId(value = "hEM3hCTajA49HfC1yOz59ljz5cAJsa6W")
// )
...
// People in their 20s: List(Person(Adam,21,None,Set(),List(),StringId(N8eiyZnq9xOMjVW49sZlBgPbVI0mvJlj)), Person(Adam,21,None,Set(),List(),StringId(D41g9MV8JBY5w3j2dSbcITvbUqqMMV9b)), Person(Adam,21,None,Set(),List(),StringId(MeJiHSHvAQ6z3KaVoU2pmmNnODArxrvF)), Person(Adam,21,None,Set(),List(),StringId(Y81Ax0W5hN5GdknRGoNNEig0M0vvGDvB)), Person(Adam,21,None,Set(),List(),StringId(vQK4xuV0nuZPjCZLcP2aOP9d0Kq0216Q)), Person(Adam,21,None,Set(),List(),StringId(KQF0wsatLpGvl1ubfteujz0wL94fFG05)), Person(Adam,21,None,Set(),List(),StringId(2ozhMJbWjLuu3OXTgqx6SsHRb0Wf43kr)), Person(Adam,21,None,Set(),List(),StringId(hEM3hCTajA49HfC1yOz59ljz5cAJsa6W)))
```
...
// Results: List(MaterializedAggregate({"ageMin": 21, "ageMax": 21, "ageAvg": 21.0, "ageSum": 168},repl.MdocSession$MdocApp$Person$@104b36c5))
```
