...
To add all modules:
```scala
libraryDependencies += "com.outr" %% "lightdb-all" % "4.39.0"
```

For a specific implementation like Lucene:
```scala
libraryDependencies += "com.outr" %% "lightdb-lucene" % "4.39.0"
```
...
```scala
libraryDependencies += "com.outr" %% "lightdb-tantivy" % "4.39.0"
```

For graph traversal utilities:
```scala
libraryDependencies += "com.outr" %% "lightdb-traversal" % "4.39.0"
```

For OpenSearch:
```scala
libraryDependencies += "com.outr" %% "lightdb-opensearch" % "4.39.0"
```
...
//   input = FlatMap(
//     input = Suspend(
//       f = lightdb.store.Store$TransactionBuilder$$Lambda/0x0000000031994c08@7ce5ea7,
...
//       )
//     ),
//     f = lightdb.store.Store$TransactionBuilder$$Lambda/0x00000000319965d8@1c46e3c7,
//     trace = SourcecodeTrace(
//       file = File(
//         "/home/mhicks/projects/open/lightdb/core/src/main/scala/lightdb/store/Store.scala"
//       ),
...
//     )
//   ),
//   f = lightdb.store.Store$TransactionBuilder$$Lambda/0x0000000031997168@1b8eb9f8,
//   trace = SourcecodeTrace(
//     file = File(
//       "/home/mhicks/projects/open/lightdb/core/src/main/scala/lightdb/store/Store.scala"
//     ),
...
//   nicknames = Set(),
//   friends = List(),
//   _id = StringId("BRg8MOGwU0nvPC1uYNfXAUDOGQvMH4e3")
// )
...
// Results: List(MaterializedAggregate({"ageMin": 21, "ageMax": 21, "ageAvg": 21.0, "ageSum": 1239},repl.MdocSession$MdocApp$Person$@65cc54c6,Map()))
```
...
//   _id = StringId("hk1J46PUUFTphJFRGdayXQud2J3FnhPv")
// )
...
// tenantA: HashMapStore[TenantDoc, TenantDoc] = lightdb.store.hashmap.HashMapStore@43b86b96
tenantA.transaction(_.insert(TenantDoc("hello"))).sync()
// res14: TenantDoc = TenantDoc(
//   value = "hello",
//   _id = StringId("W3RbanLgVl88lRooQOdoeaFePzuyIhWS")
// )
```
...
//   key = "featureX",
//   store = lightdb.store.hashmap.HashMapStore@2da03d13,
//   default = repl.MdocSession$MdocApp$$Lambda/0x0000000031bc5360@32a98c80,
//   persistence = Stored
// )
...
// res18: Row = Row(
//   value = "hi sql",
//   _id = StringId("4cvJ9USVLqQibM47kGLb9zsHiCzuIFGs")
// )
```
