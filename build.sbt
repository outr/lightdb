...
val spiceVersion: String = "1.8.11"
...
val sqliteVersion: String = "3.53.1.0"

val duckdbVersion: String = "1.5.3.0"
...
lazy val apiSpice = project.in(file("api-spice"))
	...
	.settings(
		...
		libraryDependencies ++= Seq(
			...
			"com.outr" %% "spice-server-undertow" % "1.8.13" % Test,
