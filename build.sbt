...
val spiceVersion: String = "1.10.4"
...
val sqliteVersion: String = "3.53.2.0"
...
val googleAuthVersion: String = "1.49.0"
...
lazy val apiSpice = project.in(file("api-spice"))
	...
	.settings(
		...
		libraryDependencies ++= Seq(
			...
			"com.outr" %% "spice-server-undertow" % "1.10.3" % Test,
